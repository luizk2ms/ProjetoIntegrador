...
namespace prototipos.DB.Funcionario
{
    class FuncionarioDatabase
    {
        ...
        {
            string Script = @"INSERT tb_funcionario( Nm_Nome, nm_numero, tl_telefone, cel_celular,cr_cargo, ds_endereco, cpf_cpf,cp_cep,dt_datadeentrada,dt_datasaida,nm_empresa)
                                          VALUES(@Nm_Nome,@nm_numero,@tl_telefone,@cel_celular,@cr_cargo,@ds_endereco,@cpf_cpf,@cp_cep,@dt_datadeentrada,@dt_datasaida,@nm_empresa)";
